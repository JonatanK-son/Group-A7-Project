...
def run_full_pipeline_spark(sample_mode):
    ...
    from src.config import RAW_OCT, RAW_NOV, RESULTS_DIR
    ...
    # 3. Analyze
    # We will do operations and return pandas for summary
...
def main():
    ...
    parser.add_argument("--engine", choices=["dask", "spark"], default="dask", help="Execution engine to use")
    args = parser.parse_args()

    log.info("pipeline_started", engine=args.engine)
    ...
    if args.engine == "spark":
        ...
        print("\n" + "="*80)
        print(" PIPELINE RESULTS SUMMARY (DASK) ".center(80, "="))
        print("="*80)
