#!/usr/bin/env python3
"""
Standalone Dask pipeline runner — used by the Kubernetes Job and for local testing.
...
log = StructuredLogger("run_pipeline_dask")
...
def main():
    log.info("pipeline_started", engine="dask")
    ...
    if scheduler_addr:
        ...
        with Client(scheduler_addr) as client:
            ...
            results = {
                ...
                "sessions": results_pkg["sessions_sample"]
            }
    else:
